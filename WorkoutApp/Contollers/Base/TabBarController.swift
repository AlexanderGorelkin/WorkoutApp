...
final class TabBarController: UITabBarController {
    ...
    private func configure() {
        ...
        let progressController = PregressController()
        let settingsController = SettingsController()
        
        let overviewNavigation = NavBarContoller(rootViewController: overviewController)
        let sessionNavigation = NavBarContoller(rootViewController: sessionController)
        let progressNavigation = NavBarContoller(rootViewController: progressController)
        let settingsNavigation = NavBarContoller(rootViewController: settingsController)
